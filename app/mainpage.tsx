...
import CodeBackground from './components/BackgroundMainpage';
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex min-h-screen items-center justify-center font-sans flex-col">
          ...
          <div className="flex w-10 h-10 border border-gray-500/50 rounded-full hover:cursor-pointer absolute top-11/12 animate-bounce">
            <a className='m-auto' href='#about'><FaArrowDown className="text-white text-5xl w-4 h-4 font-extralight m-auto group-hover/card:text-white" /></a>
          </div>
        </div>
      </div>
    </section>
