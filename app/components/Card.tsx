...
export default function Card({ title, description, icon }: Card) {
  return (
    <div className="border border-gray-500/10 xl:w-auto w-full h-auto rounded-xl bg-gray-300/20 p-4 hover:cursor-default hover:bg-slate-950 transition-all duration-600 group/card hover:-translate-y-2">
